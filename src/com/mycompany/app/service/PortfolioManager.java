...
public class PortfolioManager implements PortfolioManagerInterface {
	...
	private Stock fromDto(StockDto stockDto) {
		...
		if(stockDto.getRecommendation() != null) newStock.setRecommendation(com.mycompany.app.model.Portfolio.ALGO_RECOMMENDATION.valueOf(stockDto.getRecommendation()));
